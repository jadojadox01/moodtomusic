...
const HowItWorks = () => {
  ...
  const steps = [
    ...
    { 
      ...
      desc: 'Our AI creates a personalized playlist matching your mood',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    { 
      ...
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" stroke极join="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-极.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
        </svg>
      )
    }
  ];
  ...
  return (
    <section id="how-it works" className="py-16 bg-slate-800/50">
      <div className="container mx-auto px-4">
        ...
        >
          See how easy it is to generate the perfect playlist for any mood in just three simple steps
        </motion.p>
        ...
        >
          <div className="bg-slate-900 rounded-2xl overflow-hidden shadow-2xl max-w-4xl mx-auto">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-slate-800">
                  <div className="text-center">
                    <svg className="animate-spin h-12 w-12 text-purple-500 mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      ...
                      <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647极"></path>
                    </svg>
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold mb-2">See Mood2Music in Action</h3>
              <p className="text-gray-300">
                Watch this short demonstration to see how easily you can generate personalized playlists based on your mood.
                Our intuitive interface makes it simple to find the perfect music for any moment.
              </p>
            </div>
          </div>
        </motion.div>
